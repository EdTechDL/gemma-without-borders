...
Then launch the game pointed at the one you pulled:

```bash
GEMMA_MODEL=gemma4:12b streamlit run app.py
```
...
`gemma4:12b` is the size the game is tuned for. Anything Ollama can serve
will run.
